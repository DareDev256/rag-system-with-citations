...
![Version](https://img.shields.io/badge/version-1.20.9-blue?style=flat-square)
![Tests](https://img.shields.io/badge/tests-510_passing-2ea44f?style=flat-square)
...
- **510 tests, zero external deps** — full mock coverage across 19 suites, runs without API keys or FAISS indexes
...
510 tests across 19 suites. All mocked — runs without API keys, FAISS indexes, or network access:
