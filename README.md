...
A production-ready Retrieval-Augmented Generation (RAG) API that provides grounded answers with explicit citations.

## Features
- **FastAPI Backend**: Async, documented endpoints.
