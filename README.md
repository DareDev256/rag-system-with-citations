...
425 tests across 17 suites. All mocked — runs without API keys, FAISS indexes, or network access:
...
│   └── synthesize.py    # LLM calls (sync + async), safe-call helpers, confidence scoring
├── retrieval/
